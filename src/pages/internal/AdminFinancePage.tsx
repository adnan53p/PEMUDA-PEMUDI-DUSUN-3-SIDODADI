...
export default function AdminFinancePage() {
  ...
  const submitIncome = async (event: FormEvent) => {
    ...
    if (incomeEvidenceFile && !MEDIA_UPLOAD_CONFIGURED) {
      notify('ImageKit belum siap. Pastikan Edge Function imagekit-media sudah dideploy dan secret ImageKit sudah dipasang.')
      return
    }
      ...
      if (incomeEvidenceFile && result.id) {
        ...
        try {
          ...
          if (!attachResult.ok) {
            ...
            evidenceMessage = ' Bukti ImageKit berhasil dilampirkan.'
          }
        } catch (error) {
